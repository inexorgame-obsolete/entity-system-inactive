...
namespace entity_system {
    ...
    EntityRelationTypeInstanceManager::EntityRelationTypeInstanceManager()
		: TypeInstanceManagerTemplate(entity_relation_type_instance_error)
    {
		// TODO: Implement!
    }
	...
	ENT_REL_TYPE_INST EntityRelationTypeInstanceManager
		::create_entity_relation_type_instance(const ENT_REL_TYPE& ent_rel_type,
	...
	
	{
		...
		ENT_REL_TYPE_INST new_relation_type_instance = std::make_shared<EntityRelationTypeInstance>(ent_rel_type,
