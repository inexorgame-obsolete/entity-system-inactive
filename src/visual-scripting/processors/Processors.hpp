...
class Processors
{
    ...
    Processors(ProcessorRegistryPtr processor_registry, GeneratorProcessorsPtr generator_processors, InOutProcessorsPtr inout_processors, LogicalProcessorsPtr logical_processors, MathProcessorsPtr math_processors);
