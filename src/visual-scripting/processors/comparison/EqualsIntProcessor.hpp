...
#include "type-system/providers/comparison/EqualsIntEntityTypeProvider.hpp"
...
namespace visual_scripting {
	...
	/// Processor for entity instances of type EQUALS_INT.
    class EqualsIntProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<EqualsIntProcessor>
    {

    	using EqualsIntEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::EqualsIntEntityTypeProvider>;
		...
		public:
    		...
    		/// @brief Constructs a new entity instance of type EQUALS_INT.
			EqualsIntProcessor(
			...
			/// Called when an entity instance of type EQUALS_INT has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type EQUALS_INT has been deleted
		...
		private:
			...
			static constexpr char LOGGER_NAME[] = "inexor.vs.p.c.eqi";
