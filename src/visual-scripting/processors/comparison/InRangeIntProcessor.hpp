...
#include "type-system/providers/comparison/InRangeIntEntityTypeProvider.hpp"
...
namespace visual_scripting {
	...
	/// Processor for entity instances of type IN_RANGE_INT.
    class InRangeIntProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<InRangeIntProcessor>
    {

    	using InRangeIntEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::InRangeIntEntityTypeProvider>;
		...
		public:
    		...
    		/// @brief Constructs a new entity instance of type IN_RANGE_INT.
			InRangeIntProcessor(
			...
			/// Called when an entity instance of type IN_RANGE_INT has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type IN_RANGE_INT has been deleted
		...
		private:
			...
			static constexpr char LOGGER_NAME[] = "inexor.vs.p.c.iri";
