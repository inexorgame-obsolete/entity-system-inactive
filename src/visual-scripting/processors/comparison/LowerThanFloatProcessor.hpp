...
#include "type-system/providers/comparison/LowerThanFloatEntityTypeProvider.hpp"
...
namespace visual_scripting {
	...
	/// Processor for entity instances of type LOWER_THAN_FLOAT.
    class LowerThanFloatProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<LowerThanFloatProcessor>
    {

    	using LowerThanFloatEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::LowerThanFloatEntityTypeProvider>;
		...
		public:
    		...
    		/// @brief Constructs a new entity instance of type LOWER_THAN_FLOAT.
			LowerThanFloatProcessor(
			...
			/// Called when an entity instance of type LOWER_THAN_FLOAT has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type LOWER_THAN_FLOAT has been deleted
		...
		private:
			...
			static constexpr char LOGGER_NAME[] = "inexor.vs.p.c.ltf";
