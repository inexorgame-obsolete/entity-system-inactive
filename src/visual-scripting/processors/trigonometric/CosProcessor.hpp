...
namespace visual_scripting {
	...
	using CosEntityTypeProviderPtr = std::shared_ptr<entity_system::type_system::CosEntityTypeProvider>;
	using EntityInstanceManagerPtr = std::shared_ptr<entity_system::EntityInstanceManager>;
	using LogManagerPtr = std::shared_ptr<inexor::logging::LogManager>;
	using EntityInstancePtr = std::shared_ptr<entity_system::EntityInstance>;

	/// Processor which listens on the creation of entity instances
	/// of type COS. Newly created entity instances of type COS
    ...
    class CosProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<CosProcessor>
    {
		...
		public:
			...
			/// Constructs the COS processor which listens on the creation
			/// of entity instances of type COS. Newly created entity
			/// instances of type COS will be initialized by connecting the
