...
namespace visual_scripting {
	...
	{
        spdlog::info("Initializing processor CONSOLE_STDIN for newly created entity instance {} of type {}",
        ...
        else
        {
		    spdlog::error("Failed to initialize processor signals for entity instance {} of type {}: Missing attribute {}",
				entity_instance->get_GUID().str(), entity_instance->get_entity_type()->get_type_name(), StdInEntityTypeProvider::CONSOLE_STDIN);
		}
	}
