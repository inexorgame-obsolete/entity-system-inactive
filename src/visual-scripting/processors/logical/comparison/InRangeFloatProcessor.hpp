...
/// @brief Processor for entity instances of type IN_RANGE_FLOAT.
class InRangeFloatProcessor : public Processor, public LifeCycleComponent, public entity_system::EntityInstanceCreatedListener, public entity_system::EntityInstanceDeletedListener, public std::enable_shared_from_this<InRangeFloatProcessor>
{
    ...
    InRangeFloatProcessor(EntityTypeManagerPtr entity_type_manager, EntityInstanceManagerPtr entity_instance_manager, LogManagerPtr log_manager);

    /// Destructor.
    ~InRangeFloatProcessor() override;
    ...
    /// @brief Called when an entity instance of type IN_RANGE_FLOAT has been created.
    /// @param entity_instance ?
    void on_entity_instance_created(EntityInstancePtr entity_instance) override;

    /// @brief Called when an entity instance of type IN_RANGE_FLOAT has been deleted.
    /// @param type_GUID ?
    /// @param inst_GUID ?
