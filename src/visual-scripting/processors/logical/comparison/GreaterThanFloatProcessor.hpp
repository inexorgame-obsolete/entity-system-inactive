...
namespace inexor::visual_scripting {
    ...
    class GreaterThanFloatProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<GreaterThanFloatProcessor>
    {

    	using GreaterThanFloatEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::GreaterThanFloatEntityTypeProvider>;
		...
		public:
			...
			GreaterThanFloatProcessor(
				const GreaterThanFloatEntityTypeProviderPtr& entity_type_provider,
