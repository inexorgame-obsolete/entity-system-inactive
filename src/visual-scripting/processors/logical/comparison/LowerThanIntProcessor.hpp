...
namespace visual_scripting {
	...
	/// Processor for entity instances of type LOWER_THAN_INT.
		  ...
		  public std::enable_shared_from_this<LowerThanIntProcessor>
    {
		...
		public:
			...
			/// Called when an entity instance of type LOWER_THAN_INT has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type LOWER_THAN_INT has been deleted
