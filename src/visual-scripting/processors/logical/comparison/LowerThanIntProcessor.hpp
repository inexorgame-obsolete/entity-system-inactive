...
/// @class LowerThanIntProcessor
/// @brief Processor for entity instances of type LOWER_THAN_INT.
class LowerThanIntProcessor : public Processor, public LifeCycleComponent, public entity_system::EntityInstanceCreatedListener, public entity_system::EntityInstanceDeletedListener, public std::enable_shared_from_this<LowerThanIntProcessor>
{
    ...
    /// @brief Constructs a new entity instance of type LOWER_THAN_INT.
    /// @param entity_type_manager The entity type manager.
    /// @param entity_instance_manager The entity instance manager.
    /// @param log_manager The log manager.
    LowerThanIntProcessor(EntityTypeManagerPtr entity_type_manager, EntityInstanceManagerPtr entity_instance_manager, LogManagerPtr log_manager);

    /// Destructor.
    ~LowerThanIntProcessor() override;
    ...
    /// @brief Called when an entity instance of type LOWER_THAN_INT has been created.
    /// @param entity_instance ?
    void on_entity_instance_created(EntityInstancePtr entity_instance) override;

    /// @brief Called when an entity instance of type LOWER_THAN_INT has been deleted.
    /// @param type_GUID ?
    /// @param inst_GUID ?
    ...
    static constexpr char LOGGER_NAME[] = "inexor.vs.p.c.lti";
};
