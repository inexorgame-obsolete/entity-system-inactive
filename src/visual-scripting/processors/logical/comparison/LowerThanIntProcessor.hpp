...
namespace inexor::visual_scripting {
    ...
    class LowerThanIntProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<LowerThanIntProcessor>
    {

    	using LowerThanIntEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::LowerThanIntEntityTypeProvider>;
		...
		public:
			...
			LowerThanIntProcessor(
				const LowerThanIntEntityTypeProviderPtr& entity_type_provider,
