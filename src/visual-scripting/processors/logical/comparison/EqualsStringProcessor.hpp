...
namespace visual_scripting {
	...
	/// Processor for entity instances of type EQUALS_STRING.
    class EqualsStringProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<EqualsStringProcessor>
    {
		...
		public:
			...
			/// Called when an entity instance of type EQUALS_STRING has been created
