...
namespace inexor::visual_scripting {
    ...
    class GreaterThanIntProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<GreaterThanIntProcessor>
    {

    	using GreaterThanIntEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::GreaterThanIntEntityTypeProvider>;
		...
		public:
			...
			GreaterThanIntProcessor(
				const GreaterThanIntEntityTypeProviderPtr& entity_type_provider,
