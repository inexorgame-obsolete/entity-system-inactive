...
namespace visual_scripting {
	...
	/// Processor for entity instances of type AND.
    class AndProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<AndProcessor>
    {
		...
		public:
			...
			/// Called when an entity instance of type AND has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type AND has been deleted
