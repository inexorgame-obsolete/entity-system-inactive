...
namespace visual_scripting {
	...
	/// Processor for entity instances of type NAND.
    class NandProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<NandProcessor>
    {
		...
		public:
			...
			/// Called when an entity instance of type NAND has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type NAND has been deleted
