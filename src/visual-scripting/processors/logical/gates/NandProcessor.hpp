...
/// @class NandProcessor
/// @brief Processor for entity instances of type NAND.
class NandProcessor : public Processor, public entity_system::EntityInstanceCreatedListener, public entity_system::EntityInstanceDeletedListener, public std::enable_shared_from_this<NandProcessor>
{

    using NandEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::NandEntityTypeProvider>;
    ...
    /// @brief Constructs a new entity instance of type NAND.
    /// @note The dependencies of this class will be injected automatically.
    /// @param entity_type_provider The entity type provider for this active component.
    /// @param entity_instance_manager The entity instance manager.
    /// @param log_manager The log manager.
    NandProcessor(const NandEntityTypeProviderPtr& entity_type_provider, EntityInstanceManagerPtr entity_instance_manager, LogManagerPtr log_manager);

    /// Destructor.
    ~NandProcessor() override;

    /// Initialization of the processor.
    void init();

    /// @brief Called when an entity instance of type NAND has been created.
    /// @param entity_instance ?
    void on_entity_instance_created(EntityInstancePtr entity_instance) override;

    /// @brief Called when an entity instance of type NAND has been deleted.
    /// @param type_GUID ?
    /// @param inst_GUID ?
    ...
    static constexpr char LOGGER_NAME[] = "inexor.vs.p.l.nand";
};
