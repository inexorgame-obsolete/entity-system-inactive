...
namespace visual_scripting {
	...
	/// Processor for entity instances of type NOT.
    class NotProcessor
    	: public Processor,
		  ...
		  public std::enable_shared_from_this<NotProcessor>
    {
		...
		public:
			...
			/// Called when an entity instance of type NOT has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type NOT has been deleted
