...
class OrProcessor : public Processor, public entity_system::EntityInstanceCreatedListener, public entity_system::EntityInstanceDeletedListener, public std::enable_shared_from_this<OrProcessor>
{

    using OrEntityTypeProviderPtr = std::shared_ptr<inexor::entity_system::type_system::OrEntityTypeProvider>;
    ...
    OrProcessor(const OrEntityTypeProviderPtr& entity_type_provider, EntityInstanceManagerPtr entity_instance_manager, LogManagerPtr log_manager);

    /// Destructor.
    ~OrProcessor() override;
    ...
    static constexpr char LOGGER_NAME[] = "inexor.vs.p.l.or";
};
