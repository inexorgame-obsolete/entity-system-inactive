...
namespace visual_scripting {
		  ...
		  public std::enable_shared_from_this<XorProcessor>
    {
		...
		public:
			...
			/// Called when an entity instance of type XOR has been created
			void on_entity_instance_created(EntityInstancePtr entity_instance);

			/// Called when an entity instance of type XOR has been deleted
