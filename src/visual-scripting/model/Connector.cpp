...
Connector::Connector(const EntityAttributeInstancePtr &output_attr, const EntityAttributeInstancePtr &input_attr) : entity_system::GUIDBase()
{
...
Connector::Connector(const xg::Guid &connector_GUID, const EntityAttributeInstancePtr &output_attr, const EntityAttributeInstancePtr &input_attr) : GUIDBase(connector_GUID)
{
    this->output_attr = output_attr;
    this->input_attr = input_attr;
    this->output_attribute_GUID = output_attr->get_GUID();
