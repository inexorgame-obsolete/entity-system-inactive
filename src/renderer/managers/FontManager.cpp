...
namespace renderer {
	...
	FontPtrOpt FontManager::load_internal(std::string internal_filename, float size, std::string glyphs, int capacity, float render_size, Magnum::Text::Alignment alignment)
	{
	...
	FontPtrOpt FontManager::load(std::string path, float size, std::string glyphs, int capacity, float render_size, Magnum::Text::Alignment alignment)
	{
		FontPtrOpt font = instantiate();
		if (font.has_value())
		{
	...
	void FontManager::create_and_fill_glyph_cache(FontPtr font, std::string glyphs)
	{
	...
	void FontManager::prepare_renderer_and_shader(FontPtr font, int capacity, float render_size, Magnum::Text::Alignment alignment)
	{
		// Prepare renderer
