...
{
    return entity_instance_builder_factory->get_builder(BoolConstant::TYPE_NAME)->attribute(BoolConstant::NAME, "")->attribute(BoolConstant::VALUE, false)->build();
}

EntityInstancePtrOpt BoolConstantFactory::create_instance(const std::string &name, const bool &value)
{
    return entity_instance_builder_factory->get_builder(BoolConstant::TYPE_NAME)->attribute(BoolConstant::NAME, name)->attribute(BoolConstant::VALUE, value)->build();
}
