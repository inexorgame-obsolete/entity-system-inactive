...
class ComparisonProviders
{
    ...
    ComparisonProviders(EqualsBoolEntityTypeProviderPtr equals_bool_entity_type_provider, EqualsIntEntityTypeProviderPtr equals_int_entity_type_provider, EqualsStringEntityTypeProviderPtr equals_string_entity_type_provider,
                        ...
                        LowerThanIntEntityTypeProviderPtr lower_than_int_entity_type_provider, LowerThanFloatEntityTypeProviderPtr lower_than_float_entity_type_provider, InRangeIntEntityTypeProviderPtr in_range_int_entity_type_provider,
