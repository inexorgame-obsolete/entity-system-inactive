...
namespace entity_system {
	...
	#define CREATE_ENT_INST(ent_type)\
		entsys->create_entity_instance(ent_type)
	...
	#define CREATE_ENT_ATTR_INST(ent_attr_type)\
		entsys->create_entity_attribute_instance(ent_attr_type)
    ...
    #define CREATE_ENT_REL_INST(ent_rel_type)\
		entsys->create_entity_relation_instance(ent_rel_type)
	...
	#define CREATE_ENT_REL_ATTR_INST(ent_rel_attr_type)\
		entsys->create_entity_relation_attribute_instance(ent_rel_attr_type)
	...
	#define DELETE_ENT_INST(identifier)\
		entsys->delete_entity_instance(identifier)
	...
	#define DELETE_ENT_ATTR_INST(identifier)\
		entsys->delete_entity_attribute_instance(identifier)
	...
	#define DELETE_ENT_REL_INST(identifier)\
		entsys->delete_entity_relation_instance(identifier)
	...
	#define DELETE_ENT_REL_ATTR_INST(identifier)\
		entsys->delete_entity_relation_attribute_instance(identifier)
