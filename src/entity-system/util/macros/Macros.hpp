...
namespace entity_system {
	...
	/// Macro for creating an entity instance with EntityInstanceManager.
	#define CREATE_ENT_INST(ent_type)\
	entity_system->create_entity_instance(ent_type)

	/// Macro for creating an entity attribute type with EntityAttributeTypeManager.
	...
	/// Macro for creating an entity attribute instance with EntityAttributeInstanceManager.
	#define CREATE_ENT_ATTR_INST(ent_attr_type)\
	entity_system->create_entity_attribute_instance(ent_attr_type)

	/// Macro for creating an entity relation type with EntityRelationTypeManager.
	...
	/// Macro for creating an entity relation instance with EntityRelationInstanceManager.
	#define CREATE_ENT_REL_INST(ent_rel_type)\
	entity_system->create_entity_relation_instance(ent_rel_type)

	/// Macro for creating an entity relation attribute type with EntityRelationAttributeTypeManager.
	...
	/// Macro for creating an entity relation attribute instance with EntityRelationAttributeInstanceManager.
