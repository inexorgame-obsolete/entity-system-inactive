...
RelationTypeBuilder::RelationTypeBuilder(RelationTypeManagerPtr relation_type_manager, RelationAttributeTypeManagerPtr relation_attribute_type_manager, RelationAttributeInstanceManagerPtr relation_attribute_instance_manager)
{
...
RelationTypeBuilder::~RelationTypeBuilder() = default;
...
RelationTypeBuilderPtr RelationTypeBuilder::name(std::string relation_type_name)
{
    ...
    this->relation_type_name = std::move(relation_type_name);
...
RelationTypeBuilderPtr RelationTypeBuilder::uuid(std::string relation_type_uuid)
{
    ...
    this->relation_type_uuid = std::move(relation_type_uuid);
    return shared_from_this();
}
...
RelationTypeBuilderPtr RelationTypeBuilder::source(EntityTypePtr ent_type_source)
{
    ...
    this->ent_type_source = std::move(ent_type_source);
    return shared_from_this();
}
...
RelationTypeBuilderPtr RelationTypeBuilder::target(EntityTypePtr ent_type_target)
{
    ...
    this->ent_type_target = std::move(ent_type_target);
    return shared_from_this();
}
