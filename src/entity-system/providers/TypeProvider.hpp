...
template <typename T, typename BUILDER_MANAGER> class TypeProvider
{
    public:
    ...
    TypeProvider(std::shared_ptr<BUILDER_MANAGER> type_builder_manager, const std::string &type_name, const AttributeList &type_attributes)
    {
