...
class RelationManager
{
    ...
    RelationManager(std::shared_ptr<RelationTypeManager> entity_relation_type_manager, std::shared_ptr<RelationInstanceManager> entity_relation_instance_manager,
                    std::shared_ptr<RelationAttributeTypeManager> entity_relation_attribute_type_manager, std::shared_ptr<RelationAttributeInstanceManager> entity_relation_attribute_instance_manager);
