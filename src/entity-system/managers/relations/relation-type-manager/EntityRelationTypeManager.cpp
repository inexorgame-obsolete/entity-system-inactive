...
namespace entity_system {
    ...
    : TypeManagerTemplate(entity_relation_type_error)
    {
		// TODO: Implement!
    }
	...
	ENT_REL_TYPE EntityRelationTypeManager::create_entity_relation_type(const std::string& ent_rel_type_name, const ENT_TYPE& ent_type_source, const ENT_TYPE& ent_type_target)
	{
