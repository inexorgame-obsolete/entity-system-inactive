...
namespace entity_system {
    ...
    EntityRelationTypeManager::EntityRelationTypeManager() : TypeManagerTemplate()
    {
		// TODO: Implement!
    }
	...
	std::optional<ENT_REL_TYPE> EntityRelationTypeManager::create_entity_relation_type(const std::string& ent_rel_type_name, const ENT_TYPE& ent_type_source, const ENT_TYPE& ent_type_target)
	{
        ...
        return std::optional<ENT_REL_TYPE> { new_ent_relation_type };
	}
