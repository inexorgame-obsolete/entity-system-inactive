...
namespace entity_system {
    ...
    O_REL_INST RelationInstanceManager::create_relation_instance(const xg::Guid& rel_inst_GUID, const REL_TYPE& rel_type, const ENT_INST& ent_type_inst_source, const ENT_INST& ent_type_inst_target)
	{
		...
		// Create a new entity relation type instance.
		REL_INST new_relation_instance = std::make_shared<RelationInstance>(rel_inst_GUID, rel_type, ent_type_inst_source, ent_type_inst_target);
