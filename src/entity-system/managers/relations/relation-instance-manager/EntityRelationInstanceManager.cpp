...
namespace entity_system {
	...
	ENT_REL_INST EntityRelationInstanceManager::create_entity_relation_instance(const ENT_REL_TYPE& ent_rel_type, const ENT_INST& ent_type_inst_source, const ENT_INST& ent_type_inst_target)
	{
		...
		return new_relation_instance;
	}


	const std::size_t EntityRelationInstanceManager::get_relation_instances_count() const
	{
        // Read only, no mutex required.
