...
namespace entity_system {
	...
	bool EntityAttributeTypeManager::does_entity_attribute_type_exist(const xg::Guid& type_GUID)
	{
		// Call template base class method.
		return does_entity_attribute_type_exist(type_GUID);
	}

	bool EntityAttributeTypeManager::does_entity_attribute_type_exist(const EntityAttributeTypePtr& attr_type)
	{
		// Call template base class method.
		return does_entity_attribute_type_exist(attr_type->get_GUID());
	}
