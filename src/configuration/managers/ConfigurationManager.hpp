...
class ConfigurationManager
{
    ...
    ConfigurationManager(BoolConstantFactoryPtr bool_constant_factory, IntConstantFactoryPtr int_constant_factory, FloatConstantFactoryPtr float_constant_factory, StringConstantFactoryPtr string_constant_factory, LogManagerPtr log_manager);
    ...
    /// @param config_name The name of the configuration.
    bool get_bool(const std::string& config_name);
    ...
    /// who only differ in return type, we have to include the type in the method name.
    /// @param config_name The name of the configuration.
    float get_float(const std::string& config_name);
    ...
    /// @param config_name The name of the configuration.
    DataType get_type(const std::string& config_name);
    ...
    void insert(const std::string& config_name, const std::string& attribute_name, EntityInstancePtrOpt config_item);
