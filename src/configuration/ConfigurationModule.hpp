...
/// @brief This module provides a system for setting and getting configurations.
class ConfigurationModule
{
    ...
    ConfigurationModule(ConfigurationManangerPtr configuration_manager, CommandLineArgumentsConfigurationInitializerPtr command_line_arguments_configuration_initializer, EnvVarConfigurationInitializerPtr env_var_configuration_initializer,
