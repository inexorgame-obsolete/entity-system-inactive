...
EntityInstanceApi::EntityInstanceApi(std::shared_ptr<inexor::entity_system::EntitySystem> entity_system) {
	...
	this->publish(spEntityInstanceApiEntitiesInstancesResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidAttributesNameResource);
	...
	this->publish(spEntityInstanceApiRelationshipsInstancesStartStart_entity_instance_uuidEndEnd_entity_instance_uuidResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsRelationship_type_uuidResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidAttributesResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsRelationship_type_uuidIncomingResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsIncomingResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsRelationship_type_uuidOutgoingResource);
	...
	this->publish(spEntityInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsOutgoingResource);
	
}

EntityInstanceApi::~EntityInstanceApi() {}

void EntityInstanceApi::startService(int const& port) {
...
void EntityInstanceApi::stopService() {
	this->stop();
}
