...
RelationshipInstanceApi::RelationshipInstanceApi(std::shared_ptr<inexor::entity_system::EntitySystem> entity_system) {
	...
	this->publish(spRelationshipInstanceApiRelationshipsInstancesResource);
	...
	this->publish(spRelationshipInstanceApiRelationshipsInstancesStartStart_entity_instance_uuidEndEnd_entity_instance_uuidResource);
	...
	this->publish(spRelationshipInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsRelationship_type_uuidResource);
	...
	this->publish(spRelationshipInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsResource);
	...
	this->publish(spRelationshipInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsRelationship_type_uuidIncomingResource);
	...
	this->publish(spRelationshipInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsIncomingResource);
	...
	this->publish(spRelationshipInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsRelationship_type_uuidOutgoingResource);
	...
	this->publish(spRelationshipInstanceApiEntitiesInstancesEntity_instance_uuidRelationshipsOutgoingResource);
	
}

RelationshipInstanceApi::~RelationshipInstanceApi() {}

void RelationshipInstanceApi::startService(int const& port) {
...
void RelationshipInstanceApi::stopService() {
	this->stop();
}
