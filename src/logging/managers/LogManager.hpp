...
class LogManager : public entity_system::EntityInstanceCreatedListener, public entity_system::EntityInstanceDeletedListener, public std::enable_shared_from_this<LogManager>
{
    public:
    /// @brief Constructor.
    ...
    EntityInstancePtrOpt register_logger(const std::string &logger_name);
    ...
    void set_level(const std::string &logger_name, spdlog::level::level_enum level);

    /// Returns the log level for the given logger.
    /// @param logger_name The name of the logger.
    spdlog::level::level_enum get_level(const std::string &logger_name);

    /// Get method for the logger.
    /// @param logger_name The name of the logger.
    EntityInstancePtrOpt get_logger(const std::string &logger_name);
