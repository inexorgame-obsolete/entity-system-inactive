...
// TODO: move namespace react into namespace inexor::visual_scripting
...
class Connector : public entity_system::GUIDBase
{
    ...
    Connector(const EntityAttributeInstancePtr &output_attr, const EntityAttributeInstancePtr &input_attr);
    ...
    /// @param output_attr GUID of the output attribute.
    /// @param input_attr GUID of the input attribute.
    Connector(const xg::Guid &connector_GUID, const EntityAttributeInstancePtr &output_attr, const EntityAttributeInstancePtr &input_attr);
