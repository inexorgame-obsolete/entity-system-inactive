...
TEST(EntityTypeInstanceTests, TODO)
{
	...
	*/
	...
	//EXPECT_EQ(pickup1->get_attribute_data_int(weapon_dmg), dmg_val);
	
	//const int weight_val = 134;
	//pickup1->set_attribute_data(weapon_weight, weight_val);
	//EXPECT_EQ(pickup1->get_attribute_data_int(weapon_weight), weight_val);

	//const int magazine_size = 60;
	//pickup1->set_attribute_data(weapon_magazine_size, magazine_size);
	//EXPECT_EQ(pickup1->get_attribute_data_int(weapon_magazine_size), magazine_size);
}
