...
TEST(Tests_EntityAttributeTypeInstance, get_entity_attribute_data_type)
{
	...
	//EXPECT_EQ(vehicle_weight->get_entity_attribute_data_type().c_str(), ent_attr_data_type.c_str());
	...
	//EXPECT_EQ(car_weight->get_entity_attribute_data_type(), ent_attr_data_type);
	//EXPECT_EQ(bike_weight->get_entity_attribute_data_type(), ent_attr_data_type);
	//EXPECT_EQ(boat_weight->get_entity_attribute_data_type(), ent_attr_data_type);
	//EXPECT_EQ(airplane_weight->get_entity_attribute_data_type(), ent_attr_data_type);
}
