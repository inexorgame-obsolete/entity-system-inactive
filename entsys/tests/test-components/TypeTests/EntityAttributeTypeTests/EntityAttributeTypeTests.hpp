...
TEST(Test_EntityAttributeType, get_entity_attribute_type_name)
{
	...
	ASSERT_EQ(new_ent_attr1->get_type_name(), "weight");
...
TEST(Test_EntityAttributeType, get_entity_attribute_data_type)
{
	...
	ASSERT_EQ(new_ent_attr1->get_attribute_data_type(), ent_attr_data_type);
	ASSERT_EQ(new_ent_attr1->get_attribute_data_type(), ENTSYS_DATA_TYPE_BOOL);
